...
Step 10: Press Esc key (make sure the plot is in focus)
Step 11: Use horizontal cursor to estimate the pressures for each of the syringe volumes (by position and left clicking the mouse)
...
ax.set_title('Close plot window when finished changing volume')
...
cummulativeDeltaVolume = np.arange(50,-1,-5)
